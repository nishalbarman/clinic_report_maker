    ...
    <div class="content">
        ...
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <input id="serial" type="number" placeholder="Serial number" value="<?php echo $serial; ?>" name="p_serial" />
                <br>
                <label>Sample Lab No. :</label>
                <input id="sample" type="text" placeholder="Sample Number" value="<?php echo $sample; ?>" required name="patient_sample" />
                <br>
                <label>Report Date. :</label>
                <input type="date" onfocus="this.showPicker()" value="<?php echo $date; ?>" required name="report_date" />
                <br>
                <label>Reffered By:</label>
                <input id="report_date" type="text" placeholder="Dr Name" value="<?php echo $reffered; ?>" required name="dr_name" />
                <br>
                <label>Name:</label>
                <input id="name" type="text" placeholder="Enter Name" value="<?php echo $name; ?>" required name="patient_name" />
                <br>
                <label>Age</label>
                ...
                <input id="abo" type="text" step="any" min="0" placeholder="ABO Group" name="abo" value="<?php echo $abs_eo; ?>" required />
                <br>
                <label>Rh Group</label>
                <input id="rh" type="text" step="any" min="0" placeholder="Rh Group" name="rh" value="<?php echo $abs_ne; ?>" required/>
                <br>
                <br>
                <input type="submit" name="create" class="button" />
